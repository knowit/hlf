...
import static no.hlf.godlyd.api.security.SecurityConstants.HEADER_STRING;
import static no.hlf.godlyd.api.security.SecurityConstants.SECRET;
import static no.hlf.godlyd.api.security.SecurityConstants.TOKEN_PREFIX;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
        ...
        try{
            Bruker creds = new ObjectMapper().readValue(req.getInputStream(), Bruker.class);
