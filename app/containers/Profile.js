...
export default class extends Component {
    ...
    render() {
        return (
            <ViewContainer heightAdjusting="flex" opaque={true} style={{ paddingBottom: 0 }}>
                ...
                <ViewContainer heightAdjusting="flex" scrollable={true} transparent={true} style={{ padding: 0 }}>
